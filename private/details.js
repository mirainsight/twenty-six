...
window.PARTY_DETAILS = {
  ...
  guests: [
    ...
    { name: "Dini",           status: "pending"},
    { name: "Emily Liew",     status: "pending"},
    { name: "Mabel",          status: "pending"},
    { name: "Melanie",        status: "pending"},
    { name: "Ruijie",         status: "pending"},
    { name: "Cayman",         status: "pending"},
    { name: "Je Jyne",        status: "pending"},
    { name: "Jo Wong",        status: "pending"},
    { name: "Nat Wong",       status: "pending"},
    { name: "Shania Perkins", status: "pending"},
    { name: "Stacy",          status: "pending"},
    { name: "Avryl",          status: "pending"},
    { name: "Adanni",         status: "yes"    },
    { name: "Herman",         status: "pending"},
    { name: "Nic Tan",        status: "pending"},
    { name: "Caitlin",        status: "pending"},
    { name: "Nat Heng",       status: "pending"},
    { name: "Hayley",         status: "pending"},
    { name: "Kim Liew",       status: "pending"},
    { name: "Bev",            status: "no"     },
