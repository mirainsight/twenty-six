...
window.PARTY_DETAILS = {
  ...
  guests: [
    ...
    { name: "Zoe Pang",       status: "yes"    },
    { name: "Ellysa",         status: "yes"    },
    { name: "Yen Joo",        status: "no"     },
    { name: "Dini",           status: "no"     },
    { name: "Emily Liew",     status: "yes"    },
    { name: "Mabel",          status: "yes"    },
    { name: "Melanie",        status: "yes"    },
    { name: "Ruijie",         status: "no"     },
    ...
    { name: "Leana",          status: "pending"},
    { name: "Aaron",          status: "pending"},
    { name: "Annabelle",      status: "pending"},
    { name: "Shaun",          status: "heart"  }
  ],

  guestNote: "Joyce, Dini, Nic, Bev, Kelly and Jia Xin are overseas this year. Wanted them here all the same.",
  ...
  wishlist: [
    ...
    { id: "pillowcase", group: "buy",  name: "Satin pillow case",
      note: "For my frizzy hair." },
    ...
    { id: "lipbalm",    group: "buy",  name: "Lip balm",
      note: "Laneige's especially — the lip balm, not the lip tint." },
    { id: "candle",     group: "buy",  name: "A candle",
      note: "Something that smells like autumn or Christmas. Cosy, but not too vanilla." },
